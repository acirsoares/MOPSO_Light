...
! include only some original functions and formats in a single object. 
!
...
!C             ==============              
!C************************************************************************
!C  ** Initialize The Sobol Sequence Generator (SSG)
...
!C             ===========              
!C************************************************************************
!C  ** Destructs the Sobol Sequence Generator (SSG)
    SUBROUTINE DESTRUCTOR(SSG)
    TYPE(SobolSequenceGenerator_CLASS) :: SSG
    write(*,*) "DESTRUCTOR SOBOL OK"
